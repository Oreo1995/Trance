package com.trance.multi.trance.ViewPager;
...
//        Fragment fg = new Fragment();
        ...
        mViewPager.addOnPageChangeListener(new OnMyPageChangeListener());//滚动状态监听，minSdkVersion：23
        mViewPager.getCurrentItem();//获取当前显示页索引
        mViewPager.getOffscreenPageLimit();//获取缓存页面数
        mViewPager.onSaveInstanceState();
//        mViewPager.setPageTransformer(5);
        setPageNum(0);//设置显示首页
    }
